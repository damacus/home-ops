...
assert_yq 'explode(.) | .spec.values.controllers."med-tracker-canary".initContainers.migrate.image.repository == "ghcr.io/damacus/med-tracker" and .spec.values.controllers."med-tracker-canary".containers.app.image.repository == "ghcr.io/damacus/med-tracker" and .spec.values.controllers."med-tracker-canary-worker".initContainers.migrate.image.repository == "ghcr.io/damacus/med-tracker" and .spec.values.controllers."med-tracker-canary-worker".containers.worker.image.repository == "ghcr.io/damacus/med-tracker" and .spec.values.controllers.reset.containers.app.image.repository == "ghcr.io/damacus/med-tracker" and .spec.values.controllers."med-tracker-canary".initContainers.migrate.image.tag == "sha-6635c39cc31c8f536206c87f6e8d98e4ce87ada9" and .spec.values.controllers."med-tracker-canary".containers.app.image.tag == "sha-6635c39cc31c8f536206c87f6e8d98e4ce87ada9" and .spec.values.controllers."med-tracker-canary-worker".initContainers.migrate.image.tag == "sha-6635c39cc31c8f536206c87f6e8d98e4ce87ada9" and .spec.values.controllers."med-tracker-canary-worker".containers.worker.image.tag == "sha-6635c39cc31c8f536206c87f6e8d98e4ce87ada9" and .spec.values.controllers.reset.containers.app.image.tag == "sha-6635c39cc31c8f536206c87f6e8d98e4ce87ada9"' "$canary_release"
