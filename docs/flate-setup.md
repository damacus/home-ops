...
This repository uses [flate](https://github.com/home-operations/flate) to render and validate Flux configurations locally before pushing to GitHub. The local Mise commands match the GitHub Actions workflow.
...
```bash
mise run flux:flate-diff --path-orig ./default/kubernetes
```
