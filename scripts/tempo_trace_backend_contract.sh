...
assert_yq 'explode(.) | .spec.values.controllers."med-tracker-canary".initContainers.migrate.image.tag == "sha-f1accf6b8222aa485193584d4339a3a082c845ae" and .spec.values.controllers."med-tracker-canary".containers.app.image.tag == "sha-f1accf6b8222aa485193584d4339a3a082c845ae"' "$canary_release"
