...
assert_yq 'explode(.) | .spec.values.controllers."med-tracker-canary".initContainers.migrate.image.tag == "beta" and .spec.values.controllers."med-tracker-canary".containers.app.image.tag == "beta" and .spec.values.controllers.health.containers.app.image.tag == "beta" and .spec.values.controllers.reset.containers.app.image.tag == "beta"' "$canary_release"
