...
assert_yq '(.spec.values.controllers.worker.containers.worker.command | length) == 1 and .spec.values.controllers.worker.containers.worker.command[0] == "bin/jobs" and (.spec.values.controllers.worker.containers.worker.args | length) == 2 and .spec.values.controllers.worker.containers.worker.args[0] == "--mode" and .spec.values.controllers.worker.containers.worker.args[1] == "async"' "$canary_release"
assert_yq '(.spec.values.controllers.worker.containers.worker | has("probes") | not) and (.spec.values.controllers.worker.containers.worker | has("liveness") | not)' "$canary_release"
assert_yq '(.spec.values.controllers."med-tracker-canary".containers.app.env | has("SOLID_QUEUE_IN_PUMA") | not) and (.spec.values.controllers."med-tracker-canary".containers.app.env | has("SOLID_QUEUE_SUPERVISOR_MODE") | not)' "$canary_release"
assert_yq '(.spec.values.persistence | tojson | test("puma\\.rb") | not)' "$canary_release"
assert_yq 'explode(.) | .spec.values.controllers."med-tracker-canary".initContainers.migrate.image.repository == "ghcr.io/damacus/med-tracker" and .spec.values.controllers."med-tracker-canary".containers.app.image.repository == "ghcr.io/damacus/med-tracker" and .spec.values.controllers.worker.initContainers.migrate.image.repository == "ghcr.io/damacus/med-tracker" and .spec.values.controllers.worker.containers.worker.image.repository == "ghcr.io/damacus/med-tracker" and .spec.values.controllers.reset.containers.app.image.repository == "ghcr.io/damacus/med-tracker" and .spec.values.controllers."med-tracker-canary".initContainers.migrate.image.tag == "sha-94545978da33a6e2eecdaccb94fa149ce7009379@sha256:8a8a5ccd3315bc9fcfe133bd1792a6e65bed74e775150a1a5c3c8208e33d3940" and .spec.values.controllers."med-tracker-canary".containers.app.image.tag == "sha-94545978da33a6e2eecdaccb94fa149ce7009379@sha256:8a8a5ccd3315bc9fcfe133bd1792a6e65bed74e775150a1a5c3c8208e33d3940" and .spec.values.controllers.worker.initContainers.migrate.image.tag == "sha-94545978da33a6e2eecdaccb94fa149ce7009379@sha256:8a8a5ccd3315bc9fcfe133bd1792a6e65bed74e775150a1a5c3c8208e33d3940" and .spec.values.controllers.worker.containers.worker.image.tag == "sha-94545978da33a6e2eecdaccb94fa149ce7009379@sha256:8a8a5ccd3315bc9fcfe133bd1792a6e65bed74e775150a1a5c3c8208e33d3940" and .spec.values.controllers.reset.containers.app.image.tag == "sha-94545978da33a6e2eecdaccb94fa149ce7009379@sha256:8a8a5ccd3315bc9fcfe133bd1792a6e65bed74e775150a1a5c3c8208e33d3940"' "$canary_release"
