...
assert_yq 'explode(.) | .spec.values.controllers."med-tracker-canary".initContainers.migrate.image.repository == "ghcr.io/damacus/med-tracker" and .spec.values.controllers."med-tracker-canary".containers.app.image.repository == "ghcr.io/damacus/med-tracker" and .spec.values.controllers.worker.initContainers.migrate.image.repository == "ghcr.io/damacus/med-tracker" and .spec.values.controllers.worker.containers.worker.image.repository == "ghcr.io/damacus/med-tracker" and .spec.values.controllers.reset.containers.app.image.repository == "ghcr.io/damacus/med-tracker" and .spec.values.controllers."med-tracker-canary".initContainers.migrate.image.tag == "sha-9d0678e92aaea5ffc5962dd4f2f08c79c3e8025a@sha256:249572d75104df17f4bc8eb75996b97d39e530417612f9a5aa941c247105327b" and .spec.values.controllers."med-tracker-canary".containers.app.image.tag == "sha-9d0678e92aaea5ffc5962dd4f2f08c79c3e8025a@sha256:249572d75104df17f4bc8eb75996b97d39e530417612f9a5aa941c247105327b" and .spec.values.controllers.worker.initContainers.migrate.image.tag == "sha-9d0678e92aaea5ffc5962dd4f2f08c79c3e8025a@sha256:249572d75104df17f4bc8eb75996b97d39e530417612f9a5aa941c247105327b" and .spec.values.controllers.worker.containers.worker.image.tag == "sha-9d0678e92aaea5ffc5962dd4f2f08c79c3e8025a@sha256:249572d75104df17f4bc8eb75996b97d39e530417612f9a5aa941c247105327b" and .spec.values.controllers.reset.containers.app.image.tag == "sha-9d0678e92aaea5ffc5962dd4f2f08c79c3e8025a@sha256:249572d75104df17f4bc8eb75996b97d39e530417612f9a5aa941c247105327b"' "$canary_release"
